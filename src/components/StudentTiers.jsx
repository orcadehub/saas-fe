      ...
      <Container maxWidth="lg">
        <Stack alignItems="center" spacing={4} sx={{ mb: 8 }}>
          ...
          <ToggleButtonGroup
            ...
            sx={{
              bgcolor: '#fff', borderRadius: '100px', p: 0.5,
              ...
              '& .MuiToggleButton-root': {
                ...
                textTransform: 'none', fontWeight: 800, color: '#64748b', fontSize: '0.85rem',
                    ...
                    <Stack spacing={2} sx={{ mb: 6, flexGrow: 1 }}>
                      {[
                        ...
                        <Stack key={f} direction="row" spacing={1.5} alignItems="center">
                          ...
                          <Typography variant="body2" sx={{ fontWeight: 600, color: '#475569' }}>{f}</Typography>
                        </Stack>
                      ))}
                    </Stack>
