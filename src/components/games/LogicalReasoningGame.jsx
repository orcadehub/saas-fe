...
const generateDirection = () => {
  ...
  const dir2 = directions.filter(
    (d) => d !== dir1 && d !== (dir1 === 'North' ? 'South' : dir1 === 'South' ? 'North' : dir1 === 'East' ? 'West' : 'East')
...
const generateCoding = () => {
  ...
  if (type < 0.5) {
    ...
    const word1 =
      letters[Math.floor(Math.random() * 10)] + letters[Math.floor(Math.random() * 10)] + letters[Math.floor(Math.random() * 10)];
    const code1 = word1
      .split('')
...
const generateSeating = () => {
  const seating = [
    [
      '5 people sit in a row. A is left of B. B is left of C.',
      'A is leftmost',
      ['A is leftmost', 'C is leftmost', 'B is leftmost', 'Cannot say']
    ],
    [
      '4 people sit around a table. P is opposite to Q. R is right of P.',
      'R is left of Q',
      ['R is left of Q', 'R is right of Q', 'R is opposite Q', 'Cannot say']
    ]
  ];
...
const generateRanking = () => {
  ...
  const options = [
    answer,
    (total - fromTop).toString() + 'th',
    (total - fromTop + 2).toString() + 'th',
    (total - fromTop - 1).toString() + 'th'
  ];
  return {
...
const generateVennDiagram = () => {
  const venns = [
    [
      'Which diagram represents: All A are B, Some B are C?',
      'Overlapping circles',
      ['Overlapping circles', 'Separate circles', 'Concentric circles', 'Intersecting lines']
    ],
    [
      'Which represents: No A is B, All B are C?',
      'Separate circles',
      ['Separate circles', 'Overlapping circles', 'Concentric circles', 'Intersecting lines']
    ]
  ];
...
const generateOddOneOut = () => {
  ...
  if (type < 0.5) {
    ...
    return {
      question: `Find odd one: ${nums.join(', ')}`,
...
const generateMissingNumber = () => {
  ...
  if (pattern.type === 'multiply') {
    ...
    return {
      question: `Find missing: ${series.join(', ')}, ?`,
...
const reasoningQuestions = [
  ...
  {
    question: 'Some books are pens. All pens are pencils. Conclusion: Some books are pencils.',
    options: ['True', 'False', 'Cannot say', 'Partially true'],
    answer: 'True'
  },
  ...
  {
    question: 'No bird is a fish. All fish are aquatic. Conclusion: No bird is aquatic.',
    options: ['True', 'False', 'Cannot say', 'Partially true'],
    answer: 'False'
  },
  { question: 'If P = Q and Q = R, then:', options: ['P = R', 'P > R', 'P < R', 'Cannot determine'], answer: 'P = R' },
  {
    question: 'Some doctors are engineers. All engineers are graduates. Conclusion: Some doctors are graduates.',
    options: ['True', 'False', 'Cannot say', 'Partially true'],
    answer: 'True'
  },
  {
    question: 'All squares are rectangles. All rectangles are polygons. Conclusion: All squares are polygons.',
    options: ['True', 'False', 'Cannot say', 'Partially true'],
    answer: 'True'
  },
  { question: 'If X < Y and Y < Z, then:', options: ['X < Z', 'X > Z', 'X = Z', 'Cannot determine'], answer: 'X < Z' },
  {
    question: 'No teacher is a student. Some students are intelligent. Conclusion: No teacher is intelligent.',
    options: ['True', 'False', 'Cannot say', 'Partially true'],
    answer: 'False'
  },
  {
    question: 'All mangoes are fruits. Some fruits are sweet. Conclusion: All mangoes are sweet.',
    options: ['True', 'False', 'Cannot say', 'Partially true'],
    answer: 'Cannot say'
  },
  { question: 'If M = N and N > O, then:', options: ['M > O', 'M < O', 'M = O', 'Cannot determine'], answer: 'M > O' },
  {
    question: 'Some players are athletes. All athletes are fit. Conclusion: Some players are fit.',
    options: ['True', 'False', 'Cannot say', 'Partially true'],
    answer: 'True'
  },
  {
    question: 'All circles are round. No square is round. Conclusion: No circle is a square.',
    options: ['True', 'False', 'Cannot say', 'Partially true'],
    answer: 'True'
  },
  { question: 'If A = B and B < C, then:', options: ['A < C', 'A > C', 'A = C', 'Cannot determine'], answer: 'A < C' },
  {
    question: 'Some cars are vehicles. All vehicles have wheels. Conclusion: Some cars have wheels.',
    options: ['True', 'False', 'Cannot say', 'Partially true'],
    answer: 'True'
  },
  {
    question: 'All dogs are mammals. Some mammals are pets. Conclusion: All dogs are pets.',
    options: ['True', 'False', 'Cannot say', 'Partially true'],
    answer: 'Cannot say'
  },
  { question: 'If P > Q and Q = R, then:', options: ['P > R', 'P < R', 'P = R', 'Cannot determine'], answer: 'P > R' },
    ...
    <Box sx={{ maxWidth: 700, mx: 'auto', p: 3 }}>
      <Card sx={{ p: 4 }}>
        ...
        {feedback && (
          <Typography
            variant="h6"
            sx={{ mb: 2, color: feedback.includes('✓') ? 'success.main' : 'error.main', fontWeight: 600, textAlign: 'center' }}
          >
            {feedback}
          </Typography>
        )}
