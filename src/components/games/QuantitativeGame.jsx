  ...
  switch (type) {
    ...
    case 'work':
      ...
      return {
        ...
        options: [
          Math.round(combined * 10) / 10,
          Math.round((combined + 1) * 10) / 10,
          Math.round((combined - 1) * 10) / 10,
          Math.round((combined + 2) * 10) / 10
    ...
    case 'pipes':
      ...
      return {
        ...
        options: [Math.round(netTime), Math.round(netTime + 2), Math.round(netTime - 2), Math.round(netTime + 5)].sort(
          () => Math.random() - 0.5
        ),
    ...
    case 'trains':
      ...
      return {
        ...
        options: [Math.round(timeSeconds), Math.round(timeSeconds + 1), Math.round(timeSeconds - 1), Math.round(timeSeconds + 2)].sort(
          () => Math.random() - 0.5
        ),
