    ...
    <MainCard title="JD Based Mock Interview">
      ...
      {activeStep === 0 && (
        <Box>
          ...
          <Paper
            sx={{ p: 4, textAlign: 'center', border: '2px dashed', borderColor: jdFile ? 'success.main' : 'divider', cursor: 'pointer' }}
          ...
          <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 3 }}>
            <Button variant="contained" onClick={handleNext} disabled={!jdFile}>
              Next
            </Button>
          </Box>
        </Box>
