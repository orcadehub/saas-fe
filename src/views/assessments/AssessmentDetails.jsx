...
export default function AssessmentDetails() {
  ...
  const codingQuestionCount =
    assessment?.codingQuestionCount || questionCounts.programming + questionCounts.frontend + questionCounts.mongodb + questionCounts.sql;
  ...
  return (
    <Box sx={{ p: 3 }}>
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                  ...
                  <Box>
                    ...
                    <Typography
                      variant="caption"
                      sx={{ color: '#64748b', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em' }}
                    >
                      Duration
                    </Typography>
                  </Box>
              ...
              {assessment.earlyStartBuffer > 0 && (
                <Box>
                  ...
                  <Typography variant="h5" sx={{ fontWeight: 700, color: 'secondary.main' }}>
                    {new Date(new Date(assessment.startTime).getTime() + assessment.earlyStartBuffer * 60 * 1000).toLocaleTimeString(
                      'en-US',
      ...
      >
            ...
            >
              <Box sx={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <CircularProgress
                  ...
                  value={100}
                />
                <CircularProgress size={100} thickness={2} sx={{ color: '#6366f1', animationDuration: '1s' }} />
                    ...
                    <Box>
                      <Typography
                        ...
                        sx={{
                          fontWeight: 900,
                          mb: 1,
                          color: accessCheckResult?.hasAccess ? '#14532d' : '#7f1d1d',
                          letterSpacing: '-0.02em'
                        }}
                      >
                      ...
                      <Typography
                        variant="body1"
                        sx={{
                          color: accessCheckResult?.hasAccess ? '#166534' : '#991b1b',
                          fontWeight: 500,
                          lineHeight: 1.6,
                          maxWidth: 280,
                          mx: 'auto'
                      ...
                      >
                        {accessCheckResult?.message ||
                          (accessCheckResult?.hasAccess
                            ? 'Your network is recognized and secure. Ready for transmission.'
                            : 'Please switch to an authorized network to proceed.')}
                      </Typography>
                    </Box>
                  </Card>
                </Box>
        ...
        >
          <Button onClick={() => setShowNetworkCheck(false)} sx={{ color: '#64748b', fontWeight: 700, textTransform: 'none' }}>
            Cancel
          </Button>
          <Button
            variant="contained"
      ...
      >
          ...
          <Stack spacing={4}>
            ...
            <Box>
              ...
              <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: 2.5 }}>
                {[
                  {
                    icon: <AccessTime sx={{ fontSize: 26 }} />,
                    title: 'Time Sync',
                    text: 'Countdown is absolute. Sessions terminate automatically at T-00:05.'
                  },
                  {
                    icon: <Info sx={{ fontSize: 26 }} />,
                    title: 'Navigation Map',
                    text: 'Use the palette to track progress. Colored markers indicate question status.'
                  },
                  {
                    icon: <Code sx={{ fontSize: 26 }} />,
                    title: 'Data Commitment',
                    text: "Always finalize code with 'Submit' to run final test case diagnostics."
                  },
                  {
                    icon: <Laptop sx={{ fontSize: 26 }} />,
                    title: 'Security Measures',
                    text: 'Proctoring is active. Tab switching or external tools will be flagged.'
                  }
                ].map((item, idx) => (
                  <Box
                    key={idx}
            ...
            <Box sx={{ p: 4, borderRadius: '24px', bgcolor: '#fff7ed', border: '1px solid #fed7aa' }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
                ...
                <Typography variant="h3" sx={{ fontWeight: 900, color: '#9a3412', letterSpacing: '-0.02em' }}>
                ...
                {[
                  {
                    ...
                    rules: [
                      'Zero Tolerance: No tab switching or window minimizing.',
                      'Auto-Lockout: Any detected navigation away terminates the session.',
                      'No Retakes: Flagged attempts are submitted immediately.'
                    ]
                  },
                  {
                    num: '2',
                    title: 'Technical Stability',
                    rules: ['Freezes: If stuck for >30s, reload the page manually.', 'Connectivity: Ensure stable internet before launch.']
                  },
                  {
                    num: '3',
                    title: 'Final Warnings',
                    rules: ['Close all other apps (Chat, Spotify, etc.).', 'Clicking Start confirms acceptance of all consequences.']
                  }
                ].map((section) => (
                  <Box key={section.num}>
                    <Typography variant="h5" sx={{ fontWeight: 900, color: '#c2410c', mb: 1.5 }}>
                    ...
                    <Stack spacing={1}>
                      {section.rules.map((rule, i) => (
                        <Box key={i} sx={{ display: 'flex', gap: 1.5, alignItems: 'flex-start' }}>
                          ...
                          <Typography variant="body2" sx={{ color: '#9a3412', fontWeight: 600, lineHeight: 1.7 }}>
                            {rule}
                          </Typography>
                        </Box>
                      ))}
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: 3 }}>
              <Box sx={{ p: 3.5, borderRadius: '24px', bgcolor: '#f1f5f9', border: '1px solid #e2e8f0' }}>
                <Typography variant="h4" sx={{ fontWeight: 900, color: '#0f172a', mb: 3 }}>
                  Status Legend
                </Typography>
                <Stack spacing={2}>
                  {[
                    ...
                    <Box key={i} sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                      <Box
                        sx={{
                          ...
                          alignItems: 'center',
                          justifyContent: 'center',
                          color: s.color === 'transparent' ? '#6366f1' : 'white',
                          fontWeight: 900,
                          fontSize: '0.875rem'
                        }}
                      >
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 700, color: '#334155', fontSize: '0.95rem' }}>
                        {s.label}
                      </Typography>
                    </Box>
                  ))}
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 2 }}>
                  ...
                  <Typography variant="h5" sx={{ fontWeight: 900, color: '#991b1b' }}>
                    Mission Critical Alert
                  </Typography>
                </Box>
                <Typography variant="body2" sx={{ color: '#b91c1c', fontWeight: 600, lineHeight: 1.7, fontSize: '0.95rem' }}>
                  Active proctoring is enabled. Any attempt to switch tabs or utilize external assistance will result in immediate session
                  termination.
                </Typography>
              </Box>
            </Box>
        ...
        >
          <FormControlLabel
            ...
            label={<Typography sx={{ fontWeight: 800, color: '#334155', ml: 1 }}>I acknowledge all protocols</Typography>}
          />
          <Box sx={{ display: 'flex', gap: 2 }}>
            <Button onClick={() => setShowInstructions(false)} sx={{ color: '#64748b', fontWeight: 800 }}>
              Abort
            </Button>
            <Button
              variant="contained"
