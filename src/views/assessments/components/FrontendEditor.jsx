    ...
    >
      ...
      >
        <Stack direction="row" alignItems="center" spacing={2.5}>
          ...
          >
            ...
            <Typography
              variant="body2"
              sx={{ minWidth: '32px', textAlign: 'center', fontWeight: 900, color: '#0f172a', fontFamily: 'JetBrains Mono' }}
            >
              {fontSize}px
            </Typography>
      ...
      >
        ...
        <Box
          sx={{
            ...
            borderRight: showPreview ? '1px solid #f1f5f9' : 'none'
          }}
        >
          {/* File Tabs */}
          <Box
          ...
          >
            {Object.keys(files).map((filename) => (
              ...
              >
                <InsertDriveFile
                  sx={{ fontSize: 16, color: activeFile === filename ? '#6366f1' : 'inherit', opacity: activeFile === filename ? 1 : 0.6 }}
                />
                <Typography
                  variant="body2"
                  sx={{ fontWeight: activeFile === filename ? 800 : 700, fontSize: '0.8rem', letterSpacing: '-0.01em' }}
                >
                  {filename}
                </Typography>
        ...
        {showPreview && (
          <Box sx={{ width: `${previewWidth}%`, bgcolor: '#ffffff', display: 'flex', flexDirection: 'column' }}>
            ...
            >
              ...
              <Typography
                variant="body2"
                sx={{ fontWeight: 800, color: '#64748b', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}
              >
                Runtime Environment
              </Typography>
            </Box>
            ...
            <Box>
              ...
              >
                <Card sx={{ p: 3, borderRadius: '24px', bgcolor: '#f8fafc', border: '1px solid #f1f5f9', boxShadow: 'none' }}>
                  <Typography
                    variant="caption"
                    sx={{ color: '#94a3b8', fontWeight: 800, textTransform: 'uppercase', mb: 1, display: 'block' }}
                  >
                    Success Rate
                  </Typography>
                ...
                <Card
                  sx={{
                    p: 3,
                    borderRadius: '24px',
                    bgcolor: testResults.percentage >= 70 ? '#f0fdf4' : '#fef2f2',
                    border: '1px solid',
                    borderColor: testResults.percentage >= 70 ? '#dcfce7' : '#fee2e2',
                    boxShadow: 'none'
                  }}
                >
                  <Typography
                    variant="caption"
                    sx={{
                      color: testResults.percentage >= 70 ? '#22c55e' : '#ef4444',
                      fontWeight: 800,
                  ...
                  <Box sx={{ width: '100%', height: 6, bgcolor: 'rgba(255,255,255,0.5)', borderRadius: 3, mt: 1.5, overflow: 'hidden' }}>
                    <Box
                      sx={{
                        width: `${testResults.percentage}%`,
                        height: '100%',
                        bgcolor: testResults.percentage >= 70 ? '#22c55e' : '#ef4444'
                      }}
                    />
                  </Box>
                </Card>
              ...
              {testResults.error && (
                <Box sx={{ mb: 4, p: 2.5, bgcolor: '#fef2f2', border: '1px solid #fee2e2', borderRadius: '16px' }}>
                  <Typography
                    variant="body2"
                    sx={{ color: '#b91c1c', fontWeight: 800, mb: 1, display: 'flex', alignItems: 'center', gap: 1 }}
                  >
                    ...
                    <Box sx={{ flex: 1 }}>
                      ...
                      {test.error ? (
                        <Box sx={{ mt: 1, p: 1.5, bgcolor: '#ffffff', borderRadius: '8px', border: '1px solid #fee2e2' }}>
                          <Typography
                            variant="caption"
                            sx={{ color: '#ef4444', fontWeight: 700, fontFamily: 'JetBrains Mono', display: 'block', lineHeight: 1.5 }}
                          >
                            EXPECTED: {test.error}
                          </Typography>
                        </Box>
                        ...
                        <Typography variant="body2" sx={{ color: '#64748b', fontWeight: 600, mt: 0.5 }}>
                          Scenario executed and verified successfully.
                        </Typography>
                      )}
                    </Box>
                  </Box>
      ...
      >
        ...
        <DialogActions sx={{ p: 3 }}>
          <Button onClick={() => setShowNewFileDialog(false)} sx={{ fontWeight: 700, color: '#64748b' }}>
            Cancel
          </Button>
          <Button onClick={handleCreateFile} variant="contained" sx={{ borderRadius: '12px', px: 3, fontWeight: 800, bgcolor: '#6366f1' }}>
            Create File
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={confirmDelete} variant="contained" color="error" disabled={deleteConfirmText !== 'delete'}>
            Delete
          </Button>
        </DialogActions>
      </Dialog>
