    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (attemptId && question._id) {
          try {
            await apiService.saveMongoDBQuery(token, attemptId, question._id, query, response.data.result, expectedOutput, isCorrect);
          } catch (err) {
        ...
        {currentTab === 1 && (
          <Box sx={{ p: 4 }}>
            ...
            <Typography variant="body1" sx={{ color: '#64748b', mb: 3 }}>
              Currently interacting with collection:{' '}
