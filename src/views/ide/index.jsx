  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography sx={{ fontWeight: 800, color: t.text, fontSize: '1rem', mr: 1 }}>Code Editor</Typography>
          ...
          <Select
            ...
            renderValue={(val) => (
              <Stack direction="row" alignItems="center" spacing={0.75}>
                ...
                <Typography sx={{ fontWeight: 700, fontSize: '0.82rem', color: isDarkMode ? '#fff' : 'inherit' }}>
                  {langMeta[val].label}
                </Typography>
              </Stack>
            )}
        ...
        <Stack direction="row" spacing={1} alignItems="center">
          ...
          >
            <IconButton
              ...
              sx={{ color: t.textMuted, width: 28, height: 28 }}
            >
          ...
          >
            <Box
              sx={{
                ...
                height: 7,
                borderRadius: '50%',
                bgcolor: langMeta[language].color,
