      ...
      <Container maxWidth={false} sx={{ px: { xs: 2, sm: 3, md: 5 } }}>
        <Stack direction="row" alignItems="center" spacing={2.5} sx={{ mb: { xs: 3, md: 4 } }}>
          ...
          <Box>
            <Typography
              variant="h2"
              sx={{ fontWeight: 900, color: COLORS.textMain, letterSpacing: '-1px', fontSize: { xs: '1.5rem', md: '2.2rem' } }}
            >
              Portal Settings
            </Typography>
            <Typography variant="body2" sx={{ color: COLORS.textSub, fontWeight: 500 }}>
              Manage your institutional experience
            </Typography>
          </Box>
        </Stack>
                  ...
                  <Tab
                    ...
                    label={
                      <Box sx={{ textAlign: 'left' }}>
                        <Typography sx={{ fontWeight: activeTab === i ? 800 : 600, fontSize: '0.875rem', color: 'inherit' }}>
                          {tab.label}
                        </Typography>
                        {!isMobile && (
                          <Typography variant="caption" sx={{ display: 'block', opacity: 0.7, fontWeight: 500, fontSize: '0.65rem' }}>
                            {tab.desc}
                          </Typography>
                        )}
                      </Box>
                ...
                <Box sx={{ mt: 3, pt: 3, borderTop: '1px solid rgba(0,0,0,0.04)', px: 1 }}>
                  ...
                  >
                    <Stack direction="row" spacing={2} alignItems="center">
                      ...
                      <Box>
                        <Typography variant="caption" sx={{ fontWeight: 800, color: COLORS.primary, display: 'block', fontSize: '0.6rem' }}>
                          TRUSTED ACCOUNT
                        </Typography>
                        <Typography variant="subtitle2" sx={{ fontWeight: 700, color: COLORS.textMain, fontSize: '0.75rem' }}>
              ...
              >
                ...
                >
                  <CardContent sx={{ p: { xs: 3, md: 6 } }}>
                    {activeTab === 0 && (
                      <Box>
                        <Typography variant="h3" sx={{ fontWeight: 900, mb: 1, color: COLORS.textMain }}>
                          Personal Information
                        </Typography>
                        <Typography variant="body1" sx={{ color: COLORS.textSub, mb: 5 }}>
                        ...
                        <Stack
                          ...
                          alignItems="center"
                          spacing={4}
                          sx={{ mb: 6, p: 3, borderRadius: '24px', bgcolor: '#f8fafc', border: '1px solid #f1f5f9' }}
                        >
                          <Box sx={{ position: 'relative' }}>
                            <Avatar
                              src={user?.profile?.profilePic || user?.profilePic}
                              sx={{ width: 110, height: 110, boxShadow: '0 10px 30px rgba(0,0,0,0.1)', border: '4px solid #fff' }}
                            >
                              {user?.name?.charAt(0)}
                            </Avatar>
                            <IconButton
                          ...
                          <Box sx={{ textAlign: { xs: 'center', sm: 'left' } }}>
                            ...
                            <Chip
                              label="Active Member"
                              size="small"
                              sx={{ mt: 1.5, bgcolor: 'rgba(34, 197, 94, 0.1)', color: '#16a34a', fontWeight: 800, px: 1 }}
                            />
                          </Box>
                        </Stack>
                        ...
                        >
                            ...
                            InputProps={{
                              startAdornment: (
                                <InputAdornment position="start">
                                  <PersonOutline sx={{ color: COLORS.textSub, fontSize: 20 }} />
                                </InputAdornment>
                              )
                            }}
                          />
                          <TextField
                            ...
                            InputProps={{
                              startAdornment: (
                                <InputAdornment position="start">
                                  <EmailOutlined sx={{ color: COLORS.textSub, fontSize: 20 }} />
                                </InputAdornment>
                              )
                            }}
                          />
                          <TextField
                            ...
                            InputProps={{
                              startAdornment: (
                                <InputAdornment position="start">
                                  <PhoneOutlined sx={{ color: COLORS.textSub, fontSize: 20 }} />
                                </InputAdornment>
                              )
                            }}
                          />
                          <TextField
                            ...
                            InputProps={{
                              startAdornment: (
                                <InputAdornment position="start">
                                  <LocationOnOutlined sx={{ color: COLORS.textSub, fontSize: 20 }} />
                                </InputAdornment>
                              )
                            }}
                          />
                        ...
                        >
                          <Box>
                            <TextField
                              ...
                              value={socialProfiles.leetcode}
                              onChange={(e) => setSocialProfiles((p) => ({ ...p, leetcode: e.target.value }))}
                              sx={inputSx}
                              placeholder="e.g. janesmith_99"
                              InputProps={{
                                startAdornment: (
                                  <InputAdornment position="start">
                                    <TerminalOutlined sx={{ color: '#ffa116' }} />
                                  </InputAdornment>
                                )
                              }}
                            />
                            {user?.codingProfiles?.leetcode?.connected && (
                              <Typography
                                variant="caption"
                                sx={{ color: '#16a34a', fontWeight: 700, mt: 1, display: 'flex', alignItems: 'center', gap: 0.5 }}
                              >
                                <SyncOutlined sx={{ fontSize: 12 }} /> Last synced:{' '}
                                {new Date(user.codingProfiles.leetcode.lastSynced).toLocaleDateString()}
                              </Typography>
                            )}
                          </Box>
                          ...
                          <Box>
                            <TextField
                              ...
                              value={socialProfiles.hackerrank}
                              onChange={(e) => setSocialProfiles((p) => ({ ...p, hackerrank: e.target.value }))}
                              sx={inputSx}
                              placeholder="e.g. jane_ranker"
                              InputProps={{
                                startAdornment: (
                                  <InputAdornment position="start">
                                    <CodeOutlined sx={{ color: '#2ec866' }} />
                                  </InputAdornment>
                                )
                              }}
                            />
                            {user?.codingProfiles?.hackerrank?.connected && (
                              ...
                              >
                                <SyncOutlined sx={{ fontSize: 12 }} /> Last synced:{' '}
                                {new Date(user.codingProfiles.hackerrank.lastSynced).toLocaleDateString()}
                              </Typography>
                            )}
                          </Box>
                          ...
                          <Box>
                            <TextField
                              ...
                              value={socialProfiles.codeforces}
                              onChange={(e) => setSocialProfiles((p) => ({ ...p, codeforces: e.target.value }))}
                              sx={inputSx}
                              placeholder="e.g. cf_jane"
                              InputProps={{
                                startAdornment: (
                                  <InputAdornment position="start">
                                    <TerminalOutlined sx={{ color: '#1f8ee7' }} />
                                  </InputAdornment>
                                )
                              }}
                            />
                            {user?.codingProfiles?.codeforces?.connected && (
                              ...
                              >
                                <SyncOutlined sx={{ fontSize: 12 }} /> Last synced:{' '}
                                {new Date(user.codingProfiles.codeforces.lastSynced).toLocaleDateString()}
                              </Typography>
                            )}
                          </Box>
                          ...
                          <Box>
                            <TextField
                              ...
                              value={socialProfiles.codechef}
                              onChange={(e) => setSocialProfiles((p) => ({ ...p, codechef: e.target.value }))}
                              sx={inputSx}
                              placeholder="e.g. chef_jane"
                              InputProps={{
                                startAdornment: (
                                  <InputAdornment position="start">
                                    <CodeOutlined sx={{ color: '#5b4638' }} />
                                  </InputAdornment>
                                )
                              }}
                            />
                            {user?.codingProfiles?.codechef?.connected && (
                              ...
                              >
                                <SyncOutlined sx={{ fontSize: 12 }} /> Last synced:{' '}
                                {new Date(user.codingProfiles.codechef.lastSynced).toLocaleDateString()}
                              </Typography>
                            )}
                          </Box>
                        </Box>
                          ...
                          <Stack direction="row" spacing={2} alignItems="center">
                            ...
                            <Box>
                              ...
                              <Typography variant="caption" sx={{ color: COLORS.textSub, fontWeight: 600 }}>
                                Connecting these profiles will automatically pull your solved problems, ranking, and activity into your
                                dashboard heatmap.
                              </Typography>
                            </Box>
                          </Stack>
                          ...
                          {['Academic Reminders', 'System Announcements', 'Performance Analytics', 'Security Alerts'].map((label) => (
                            <Stack
                              ...
                              sx={{
                                ...
                                transition: 'all 0.2s',
                                '&:hover': { bgcolor: '#fff', borderColor: COLORS.primary }
                              }}
                            >
                              <Box>
                            ...
                            <Grid item xs={12} sm={6} key={themeName}>
                              <Box
                                sx={{
                                  p: 3,
                                  borderRadius: '20px',
                                  bgcolor: idx === 0 ? 'rgba(99, 102, 241, 0.05)' : '#f8fafc',
                                  border: `2px solid ${idx === 0 ? COLORS.primary : '#f1f5f9'}`,
                                  cursor: 'pointer',
