        ...
        <DialogContent sx={{ p: 0, display: 'flex', flexDirection: 'column', height: '100%' }}>
          <Box sx={{ display: 'grid', gridTemplateColumns: '50% 4px 50%', flexGrow: 1, height: '100%', overflow: 'hidden' }}>
              ...
              <Box sx={{ p: 3, maxWidth: '900px', mx: 'auto' }}>
                ...
                <Box sx={{ mb: 3 }}>
                  <Chip
                    ...
                    size="small"
                    color={lab.difficulty === 'Easy' ? 'success' : lab.difficulty === 'Medium' ? 'warning' : 'error'}
                  />
                </Box>
            ...
            <Box sx={{ bgcolor: '#ffffff', display: 'flex', flexDirection: 'column', height: '100%' }} data-compiler-container>
              ...
              <Box
                sx={{ height: '4px', cursor: 'row-resize', bgcolor: '#6a0dad', '&:hover': { bgcolor: '#5a0d9d' } }}
                ...
                <Box sx={{ borderBottom: '1px solid #e0e0e0' }}>
                  ...
                  >
                    <Tab
                      label={
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                          Output{testCaseResults[0]?.loading && <CircularProgress size={16} />}
                        </Box>
                      }
                      sx={{ bgcolor: testCaseResults[0]?.error ? '#ffebee' : testCaseResults[0]?.output ? '#e8f5e9' : 'transparent' }}
                    />
                  </Tabs>
                </Box>
                    ...
                    <Box sx={{ mb: 2 }}>
                      ...
                      <Box
                        sx={{
                          bgcolor: '#f5f5f5',
                          border: '2px solid',
                          borderColor: testCaseResults[0].error ? 'error.main' : 'success.main',
                          p: 2,
                          borderRadius: 1,
                      ...
                      >
                        {testCaseResults[0].loading ? (
                          <CircularProgress size={24} />
                        ) : (
                          testCaseResults[0].error || testCaseResults[0].output || 'No output'
                        )}
                      </Box>
                    </Box>
                  )}
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
            {submitResults.map((result) => (
              <Card
                ...
                sx={{
                  border: '1px solid',
                  borderColor: result.passed === true ? 'success.main' : result.passed === false ? 'error.main' : '#e0e0e0'
                }}
              >
