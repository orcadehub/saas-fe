...
import { EmojiEvents, ArrowBack, EmojiEventsTwoTone, Stars, WorkspacePremium, TrendingUp, Celebration } from '@mui/icons-material';
          ...
          <Box>
            <Stack direction="row" spacing={2} alignItems="center" mb={2}>
              <IconButton
                ...
                sx={{ color: '#64748b', bgcolor: '#fff', border: '1px solid #e2e8f0', boxShadow: '0 2px 8px rgba(0,0,0,0.03)' }}
              >
                <ArrowBack />
              </IconButton>
              <Breadcrumbs separator={<Typography sx={{ color: '#94a3b8' }}>/</Typography>}>
                <Link
                  component="button"
                  onClick={() => navigate('/practice/programming')}
                  sx={{ color: '#64748b', textDecoration: 'none', fontWeight: 600, '&:hover': { color: '#6366f1' } }}
                >
                  Orca Practice
                </Link>
                ...
                >
                  ...
                  <Avatar
                    sx={{
                      ...
                      height: isWinner ? 100 : 80,
                      mb: 3,
                      border: `4px solid ${getRankStyle(idx + 1).color}`,
                  ...
                  <Typography variant="h3" sx={{ fontWeight: 900, mb: 0.5, color: '#1e293b' }}>
                    {student.name}
                  </Typography>
                  ...
                  >
                    ...
                    <Typography
                      sx={{ color: '#64748b', fontWeight: 800, fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '1px' }}
                    >
                      Problems Solved
                    </Typography>
                  </Box>
            ...
            <Table>
              <TableHead sx={{ bgcolor: '#f8fafc' }}>
                <TableRow>
                  ...
                  <TableCell align="center" sx={{ color: '#64748b', fontWeight: 800, border: 'none', py: 3 }}>
                    PROBLEMS SOLVED
                  </TableCell>
                  <TableCell align="center" sx={{ color: '#64748b', fontWeight: 800, border: 'none', py: 3 }}>
                    CURRICULUM MASTERY
                  </TableCell>
                  <TableCell align="center" sx={{ color: '#64748b', fontWeight: 800, border: 'none', py: 3, pr: 4 }}>
                    STATUS
                  </TableCell>
                </TableRow>
              </TableHead>
