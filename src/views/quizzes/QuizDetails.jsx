...
export default function QuizDetails() {
  ...
  const quiz = {
    ...
    description:
      'Test your knowledge of Python programming fundamentals including data types, control structures, functions, and object-oriented programming concepts. This quiz covers variables, loops, functions, classes, and more.',
    duration: 60,
    questions: 5,
    quizQuestions: 10,
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      >
            ...
            <Box sx={{ p: 4, display: 'flex', gap: 3 }}>
              ...
              >
                ...
                <Box>
                  ...
                  >
                    {ipVerified ? 'Your network connection is verified.' : 'Unable to verify network connection.'}
                  </Typography>
                </Box>
              </Box>
            </Box>
        ...
        >
          <Button onClick={() => setShowNetworkCheck(false)} variant="outlined">
            Cancel
          </Button>
          <Button
            variant="contained"
        ...
        <DialogContent sx={{ p: 4 }}>
          ...
          >
            ...
            <Typography variant="body2" sx={{ color: 'error.dark', lineHeight: 1.7 }}>
              I acknowledge that I have read and understood all quiz instructions. I confirm that all computer hardware is functioning
              properly and I am not in possession of any prohibited devices including mobile phones, smartwatches, or unauthorized
              materials. I understand that any violation may result in immediate disqualification.
            </Typography>
          </Box>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center' }}>
            <FormControlLabel
              ...
              label={
                <Typography sx={{ fontWeight: 600, fontSize: '1rem' }}>I have read and agree to all instructions and terms</Typography>
              }
            />
          </Box>
        </DialogContent>
